...
df0 = pd.read_csv('../docs/data.csv', delimiter=';', encoding="utf8")
...
def task1():
    ...
    try:
        ...
        # Спортивная футболка Puma Синий 3200
    except:
...
def task2():
    ...
    try:
        ...
        # Спортивная футболка Nike Черный 3100,Спортивная толстовка Adidas Серый 6000
    except:
